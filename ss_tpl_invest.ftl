...
<ul class="rule-details">
    ...
    <li class="rule-text"><span class="rule-text-bold i18n" name="sharder-listing-exchanges">锁仓奖励</span><span class="i18n" name="sharder-details-six">正式交易前可在官网申请锁仓。锁仓奖励为锁仓的SS数量*奖励百分比（半年：4%，一年：10%）。</span></li>
