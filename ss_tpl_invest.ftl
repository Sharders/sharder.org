...
<ul class="rule-details">
    ...
    <#--<li class="rule-text"><span class="rule-text-bold i18n" name="sharder-referral-bonus">推广奖励</span><span class="i18n" name="sharder-details-second">分享个人链接或邀请码邀请好友注册豆匣，每成功注册1人可获得1个ETH白名单额度。单个账号白名单额度上限为100ETH。</span></li>-->
    <#--<li class="rule-text"><span class="rule-text-bold i18n" name="sharder-mall">投资返点</span><span class="i18n" name="sharder-details-three">如果所邀请好友参与早鸟轮或众售轮投资，邀请人可获得好友认购SS数量*5%的返点，该返点无上限。</span></li>-->
    ...
    <#--<li class="rule-text"><span class="rule-text-bold i18n" name="sharder-fiat-cast">法币参投</span><span class="i18n" name="sharder-details-five">需法币投资的用户可至豆匣商城参与实物众售。商城购物可获赠豆匣积分，豆匣积分可1:1兑换豆匣SS。</span></li>-->
    <li class="rule-text"><span class="rule-text-bold i18n" name="sharder-listing-exchanges">锁仓奖励</span><span class="i18n" name="sharder-details-six">锁仓奖励为锁仓的SS数量*奖励百分比(半年：4%，一年：10%),奖励数量有限，具体以官网公告为准。</span></li>
    ...
    <li class="rule-text"><span class="rule-text-bold i18n" name="sharder-token-return">兑换说明</span><span class="i18n" name="sharder-details-eight">提交提币申请后，用户将在3月18日00:00后在以太坊钱包中查看到SS。</span></li>
...
<div>
    ...
    <p class="generalTextColor"><span class="flow-title i18n" name="sharder-stock-exchange">3、交易所众售：</span><span class="i18n" name="sharder-exchange-issue">交易所众售以固定汇率兑换，代币由交易所发放。</span></p>
</div>
</#macro>
