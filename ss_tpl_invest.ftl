...
<#macro investRules isMobile=false>
    <ul class="rule-details">
        <li class="rule-text"><span class="rule-text-bold i18n" name="">白名单</span><span class="i18n" name="">在早鸟轮正式开始前注册账号即拥有1个ETH的白名单额度，使用白名单额度购买SS可获得额外20%SS赠送。</span></li>
        <li class="rule-text"><span class="rule-text-bold i18n" name="">推广奖励</span><span class="i18n" name="">分享个人链接或邀请码邀请好友注册豆匣，每成功注册1人可获得1个ETH白名单额度。单个账号白名单额度上限为100ETH。</li>
        <li class="rule-text"><span class="rule-text-bold i18n" name="">投资返点</span><span class="i18n" name="">如果所邀请好友参与早鸟轮或众筹轮投资，邀请人可获得好友认购SS数量*5%的返点，该返点无上限。</li>
        <li class="rule-text"><span class="rule-text-bold i18n" name="">空投福利</span><span class="i18n" name="">参与早鸟轮投资或邀请了10人以上（含10人）的账户均可获得空投奖励，系统会自动空投SS到您的豆匣账户，数额以官网公布为准。</li>
        <li class="rule-text"><span class="rule-text-bold i18n" name="">法币参投</span><span class="i18n" name="">需法币投资的用户可至豆匣商城参与实物众筹。商城购物可获赠豆匣积分，豆匣积分可1:1兑换豆匣SS。</li>
        <li class="rule-text"><span class="rule-text-bold i18n" name="">锁仓奖励</span><span class="i18n" name="">正式交易前可在官网申请锁仓。锁仓奖励为锁仓的SS数量*奖励百分比（半年：5%，一年：12%）。</li>
        <li class="rule-text"><span class="rule-text-bold i18n" name="">交易平台</span><span class="i18n" name="">预计登录：币安(Binance)、Okex、比特尔(Gate.io)、炒客(Chaoex)、Ebtcbank、比特时代(Aex.com)、Yobit、HitBTC。</span></li>
        <li class="rule-text"><span class="rule-text-bold i18n" name="">兑换说明</span><span class="i18n" name="">官网直投者在众筹轮结束后三日内发放SS；以太坊智能合约参投者自动兑换；交易所参与众筹者由交易所发放。</span></li>
        <li class="rule-text"><span class="rule-text-bold i18n" name="">退还说明</span><span class="i18n" name="">本次众筹由三个渠道：官网、以太坊智能合约、交易所进行募集。超过硬顶部分按时间先后顺序原路退回。</span></li>
    </ul>
</#macro>
...
<#macro investFlow isMobile=false>
    <div>
        ...
        <p class="generalTextColor i18n" name="sharder-flow-path-text1 i18n" name="">为了确保公平、公正、公开以及方便广大投资者参与。可以通过下面三种方式参与众筹</p>
