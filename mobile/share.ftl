...
<div class="ss-share-main ss-main">
    ...
    <h1 class="ss-title1 ss-title i18n" name="">豆匣协议（Sharder Protool）</h1>
    ...
    <div class="items">
        ...
        <img src="/r/cms/resource/sharders/img/teamphoto/share-button.png" class="button">
        <p class="ss-title4 ss-title i18n" name="">邀请好友成功参投更有高超返点奖励</p>
