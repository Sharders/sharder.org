...
<div class="ss-mian">
    <section class="ss-main-title">
        <h3 class="ss-head i18n" name="">豆匣协议token众筹</h3>
        <ul>
    ...
    <section class="ss-main-plan">
        ...
        <p class="ss-plan-text i18n" name="">本次众筹token是Sharder Storage，以下简称SS,SS是一种基于以太坊实现的合约token。Sharder总共发行500000000个SS,流通量60%为分配计划如下：</p>
    ...
    <section class="ss-main-participate">
        <div class="ss-participate-info" >
            <h3 class="ss-head i18n" name="">众筹参与流程</h3>
            <p class="generalTextColor i18n" name="sharder-flow-path-text1 i18n" name="">为了为了确保sharder贡献和支持者都有公平的参与机会以及方便广大投资者参与投资。本次token众筹有以下两种方式参与</p>
    ...
    <section class="ss-main-early-bird">
        <div class="sharder-line">
            ...
            <p  class="sharder-early-bird-text i18n" name="">1月29日9:00-2月11日23:59</p>
            <p class="sharder-line-p"><span></span></p>
        </div>
