    ...
    <div class="sharder_main">
        ...
        <ul class="sharder_bounty">
            <#--<li class="bounty_task">-->
                ...
                <#--&lt;#&ndash;<li class="task_input"><input type="text" class="input_user_info"><input type="button" value="提交" class="btn_submit"></li>&ndash;&gt;-->
                <#--</ul>-->
            <#--</li>-->
                ...
                <#--<#list activitys as activity>-->
                    ...
                    <#--<li class="bounty_task">-->
                        ...
                        <#--<span class="title_text"><span class="sharder_activity_none">活动四:</span>关注微信公众号<span-->
                                <#--class="sharder_number">奖励</span>${activity.bonus}SS</span>-->
                            <#--</label>-->
                        <#--</p>-->
