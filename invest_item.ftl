...
<div class="ss-container ss-theme-background-color">
    <div class="invest ss-main" id="invest_item">
        ...
        <section class="in-user-center">
            <button class="ss-main-btn">你当前白名单额度为:${maxSubscribe!}ETH或等价数字货币</button>
        ...
        <section class="invest-item">
            ...
            <div class="participation">
                ...
                <p>可用的白名单额度: <span>{{available}}ETH</span>=<span>{{available*currency.ETH/currency.BTC}}BTC</span>=<span>{{available*currency.ETH/currency.LTC}}LTC</span></p>
                <ul class="pay-types">
                ...
                <div class="pay-addr">
                    <span>钱包地址:</span><span id="sharder-addr">{{walletAddr}}</span><button onclick="jsCopy()">复制</button>
                </div>
                <button class="ss-main-btn pay-btn" v-on:click="prompt()">已完成转账</button>
            </div>
        </section>
...
<script>
    ...
    var app = new Vue({
        ...
        data:{
            ...
            walletAddr:'',
            currency:'',
            available:${maxSubscribe-nowSubscribe!},
        },
        methods:{
